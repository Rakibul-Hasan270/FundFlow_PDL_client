...
import aboutus from '../../../assets/lottie file/aboutus.json';

const AbooutUs = () => {
    return (
        <div>
            <SectionTitle heading='About Us' subHeading='We work to support and uplift people in need. We back various initiatives, including education, medical aid, food, and shelter. We believe that even small acts of help can bring big changes.'></SectionTitle>
            <div className="md:flex items-center justify-center">
                <div>
                    <Lottie className='md:h-[500px] md:w-[600px]' animationData={aboutus} loop={true} />
                </div>
                <div>
